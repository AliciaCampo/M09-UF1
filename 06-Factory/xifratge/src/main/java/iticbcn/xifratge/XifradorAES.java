...
public class XifradorAES {
    ...
    public static String desxifraAES(byte[] bIvIMsgXifrat, String clau) throws Exception {// Método para descifrar un mensaje con AES
    ...
    public static byte[] xifraAES(String msg, String clau) throws Exception {// Método para cifrar un mensaje con AES
        Cipher cipher = Cipher.getInstance(FORMAT_AES);// Obtener una instancia del cifrador AES en modo CBC con padding PKCS5
        SecretKeySpec key = new SecretKeySpec(clau.getBytes(), ALGORISME_XIFRAT);// Crear la clave secreta a partir de la cadena "clau"
