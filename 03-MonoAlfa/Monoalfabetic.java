...
public class Monoalfabetic {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Prueba 1 - Texto original: " + textoOriginal1);
        System.out.println("Prueba 1 - Texto cifrado: " + textoCifrado1);
        System.out.println("Prueba 1 - Texto descifrado: " + textoDescifrado1);
        System.out.println();
        ...
        System.out.println("Prueba 2 - Texto original: " + textoOriginal2);
        System.out.println("Prueba 2 - Texto cifrado: " + textoCifrado2);
        System.out.println("Prueba 2 - Texto descifrado: " + textoDescifrado2);
        System.out.println();
        ...
        System.out.println("Prueba 3 - Texto original: " + textoOriginal3);
        System.out.println("Prueba 3 - Texto cifrado: " + textoCifrado3);
        System.out.println("Prueba 3 - Texto descifrado: " + textoDescifrado3);
        System.out.println();
        ...
        System.out.println("Prueba 4 - Texto original: " + textoOriginal4);
        System.out.println("Prueba 4 - Texto cifrado: " + textoCifrado4);
        System.out.println("Prueba 4 - Texto descifrado: " + textoDescifrado4);
        System.out.println();
